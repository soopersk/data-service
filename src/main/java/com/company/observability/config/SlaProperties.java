 ...
 * that feeds baselines. Does not collide with {@link DurationBasedSlaProperties}
 * ({@code observability.sla.duration-based.*}).
 */
@Component
...
public class SlaProperties {
     ...
     * additionally baked into the duration-derived deadline (see {@link DurationBasedSlaProperties}).
     */
